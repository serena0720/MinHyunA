...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        //cell.imgMovie.image = UIImage(named:  feedItem[indexPath.row].qmovieImg)
        cell.lblTitle.text = "제목 : \(feedItem[indexPath.row].qmovieTitle)"
        
        downLoadItems()
        
        func downLoadItems(){
        let url = URL(string: feedItem[indexPath.row].qmovieImg)
